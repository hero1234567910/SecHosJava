...
import java.util.Date;
 ...
 /**
 * <p>Title: Sechos_Stockremoval</p>
 * <p>Description:</p>
 * @author 
 */
public class Sechos_Stockremoval implements Serializable {
	...
	/**出库表Guid**/
	private String outboundGuid;
	/**材料出库时间**/
	@JsonFormat( pattern="yyyy-MM-dd HH:mm:ss",timezone = "GMT+8")
	private Date drugOutDate;
	/**出库人Guid**/
	 ...
	 * 设置：出库表Guid
	 */
	public void setOutboundGuid(String outboundGuid) {
		this.outboundGuid = outboundGuid;
	}
	/**
	 * 获取：出库表Guid
	 */
	public String getOutboundGuid() {
		return outboundGuid;
	}
	/**
	 * 设置：材料出库时间
	 */
	public void setDrugOutDate(Date drugOutDate) {
		this.drugOutDate = drugOutDate;
	}
	/**
	 * 获取：材料出库时间
	 */
	public Date getDrugOutDate() {
		return drugOutDate;
	}
	/**
	 * 设置：出库人Guid
