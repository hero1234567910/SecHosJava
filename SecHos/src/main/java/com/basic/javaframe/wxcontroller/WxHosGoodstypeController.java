...
@RestController
@CrossOrigin
@RequestMapping("wx/sys/hosgoodstype")
public class WxHosGoodstypeController {

	private final static Logger logger = LoggerFactory.getLogger(WxHosGoodstypeController.class);
